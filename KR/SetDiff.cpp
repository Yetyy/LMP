//1.(set) »з текста где не опреденое кол - во пробелов, 
//надо найти элементы который повтор€ютс€.
//—делать функцию дл€ этого и передать в нее л€мбду,
//котора€ еще провер€ла бы слова на то что у них все буквы разные.
//¬ итоге найти слова которые повтор€ютс€ и не имеют повтор€ющихс€ букв
#include <set>
#include <iostream>
#include <fstream>
#include <functional>
